            ...
            <div class="row">
                                                    ...
                                                    <div class="row product-micro-row">
                                                        ...
                                                        <div class="col col-xs-7">
                                                            <div class="product-info">
                                                                <h3 class="name"><a
                                                                        href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en ) }}">@if(session()->get('language') == 'arabic') {{ $product->product_name_ar }} @else {{ $product->product_name_en }} @endif</a>
                                                                </h3>
                ...
                <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
                        ...
                        <div class="more-info-tab clearfix ">
                            ...
                            <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
                                ...
                                <li class="active"><a data-transition-type="backSlide" href="#all"
                                                      data-toggle="tab"> @if(session()->get('language') == 'arabic')
                                            الكل @else All @endif</a>
                                </li>

                                @foreach($categories as $category)

                                    <li><a data-transition-type="backSlide" href="#category{{ $category->id }}"
                                           data-toggle="tab"> @if(session()->get('language') == 'arabic') {{$category->category_name_ar}} @else {{$category->category_name_en}} @endif </a>
                                    </li>
                                @endforeach
                                ...
                                <div class="tab-pane" id="category{{ $category->id }}">
                                    <div class="product-slider">
                                        <div class="owl-carousel home-owl-carousel custom-carousel owl-theme"
                                            ...
                                            @php
                                                $catwiseproducts = App\Models\Product::where('category_id', $category->id)->orderBy('product_name_en', 'DESC')->limit(6)->get();
                                            ...
                                            @forelse( $catwiseproducts as $product)
                                                ...
                                                <!-- /.item -->
                                            @empty
                                                <h5 class="text-danger"><strong>No Available Product</strong></h5>
                                        @endforelse
                                ...
                                <div class="item item-carousel">
                                    <div class="products">
                                        <div class="product">
                                            ...
                                            <div class="product-info text-left">
                                                <h3 class="name"><a
                                                        href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en) }}"> @if(session()->get('language') == 'arabic') {{$product->product_name_ar}} @else {{$product->product_name_en}} @endif
                                                    </a></h3>
                                                <div class="rating rateit-small"></div>
                                                <div class="description"></div>
                    ...
                    <section class="section featured-product wow fadeInUp">
                        ...
                        <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
                            @foreach($skip_products_1 as $product)
                                <div class="item item-carousel">
                                    <div class="products">
                                        <div class="product">
                                            <div class="product-image">
                                ...
                                <div class="item">
                                    <div class="blog-post">
                                        <div class="blog-post-image">
                                            <div class="image"><a href="{{ route('post_details', $post->id) }}">
                                                    <img style="width: 390px; height: 216px;"src="{{ asset($post->post_image) }}" alt=""></a></div>
                                        </div>
                                        <!-- /.blog-post-image -->

                                        <div class="blog-post-info text-left">
                                            <h3 class="name"><a href="{{ route('post_details', $post->id) }}"> {{$post->post_title_en}}</a>
                                            </h3>
                                            <span class="info">Shaza Ali &nbsp;|&nbsp; {{ \Carbon\Carbon::parse($post->created_at)->diffForHumans()}} </span>
                                            <p class="text"> {!! \Illuminate\Support\Str::limit( $post->post_details_en, 50) !!}</p>
                                            <a href="{{ route('post_details', $post->id) }}" class="lnk btn btn-primary">Read more</a></div>
                                        <!-- /.blog-post-info -->
