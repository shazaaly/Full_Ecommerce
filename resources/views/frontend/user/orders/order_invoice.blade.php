    ...
    <tr>
        <td>
            <p class="font" style="margin-left: 20px;">
                ...
                <strong>Address:</strong> {{$order->division->division_name}}, {{$order->district->district_name}}
        ...
        <td>
            <p class="font">
            <h3><span style="color: green;">Invoice:</span> #Invoice {{$order->invoice_no}}</h3>
...
<table width="100%">
    ...
    @foreach($orderItems as $item)
        <tr class="font">
            ...
            <td align="center">{{$item->price}} * {{$item->qty}} = {{$item->price * $item->qty}}</td>
