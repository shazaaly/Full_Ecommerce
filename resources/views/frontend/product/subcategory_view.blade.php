        ...
        <div class="container">
            <div class="breadcrumb-inner">
                <ul class="list-inline list-unstyled">
                    ...
                    @foreach($breadcrumb_subcats as $item)
                        <li><a href="#">{{$item->category->category_name_en}}</a></li>
                    @endforeach

                    @foreach($breadcrumb_subcats as $bread)
                        <li class='active'>{{$bread->subcategory_name_en}}</li>
        ...
        <div class='container'>
            <div class='row'>
                                                ...
                                                <div class="accordion-body collapse" id="collapse{{ $category->id }}"
                                                    ...
                                                    <div class="accordion-inner">
                                                        @foreach($subcategories as $sub)
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <a href="{{ url('subcategory/product/'.$sub->id.'/'. $sub->subcategory_slug_en) }}">{{ $sub->subcategory_name_en }}</a>
                                                                </li>
                ...
                <div class='col-md-9'>
                    ...
                    @foreach($breadcrumb_subcats as $bread)
                        <span class="badge badge-danger">{{$bread->subcategory_name_en}}</span>
...
{{--                                {{ $subcatWiseProducts->links() }}--}}
                        ...
                        <div class="ajax-loadMore-products text-center" style="display: none">
                            <img style="width: 120px; height: 120px;"
                                 src="{{ asset('frontend/assets/images/Spinner-1s-200px.svg') }}">
