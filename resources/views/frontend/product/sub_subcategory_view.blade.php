        ...
        <div class="container">
            <div class="breadcrumb-inner">
                <ul class="list-inline list-unstyled">
                    ...
                    @foreach($breadSubSucCats as $item)
        ...
        <div class='container'>
            <div class='row'>
                                        ...
                                        @foreach($categories as $category)
                                            ...
                                            <div class="accordion-group">
                                                <div class="accordion-heading"><a href="#collapse{{ $category->id }}"
                                                        ...
                                                        @if(session()->get('language') == 'arabic') {{$category->category_name_ar}} @else {{$category->category_name_en}} @endif </a>
                                                </div>
                                                <!-- /.accordion-heading -->
                                                <div class="accordion-body collapse" id="collapse{{ $category->id }}"
                                                    ...
                                                    <div class="accordion-inner">
                                                        @foreach($subcategories as $sub)
                                                            ...
                                                            <ul>
                                                                <li><a href="{{ url('subcategory/product/'.$sub->id.'/'. $sub->subcategory_slug_en) }}">{{ $sub->subcategory_name_en }}</a></li>
                ...
                <div class='col-md-9'>
                    ...
                    @foreach($breadSubSucCats as $item)
                        <span class='badge badge-pill'>{{ $item->category->category_name_en }}</span>
                    @endforeach

                    @foreach($breadSubSucCats as $item)
                        <span class='badge badge-pill'>{{ $item->subcategory->subcategory_name_en }}</span>
                    @endforeach
                            ...
                            <div class="tab-pane active " id="grid-container">
                                <div class="category-product">
                                    <div class="row">
                                        ...
                                        @foreach($subSubcatWiseProducts as $product)
                                                    ...
                                                    <div class="product">
                                                        ...
                                                        <div class="product-info text-left">
                                                            <h3 class="name"><a
                                                                    ...
                                                                    @if(session()->get('language') == 'arabic') {{ $product->product_name_ar }} @else {{ $product->product_name_en }} @endif</a>
                                                            </h3>
                                                    ...
                                                    <div class="row product-list-row">
                                                        ...
                                                        <div class="col col-sm-8 col-lg-8">
                                                            <div class="product-info">
                                                                <h3 class="name"><a
                                                                        href=href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en ) }}">
                                                            ...
                                                            <!-- /.product-price -->
                                                                ...
                                                                <div
                                                                    class="description m-t-10">{!! $product->long_desc_en !!}
                                                                </div>
                                                                <div class="cart clearfix animate-effect">
                                                                    <div class="action">
                                                                        <ul class="list-unstyled">
