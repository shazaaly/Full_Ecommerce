...
{{--                                            <a href="{{ route('retuen', $order->id) }}" id="cancel"--}}
{{--                                               class="btn btn-block btn-success">Return Order</a>--}}
                    ...
                    <div class="box box-bordered border-primary">
                        ...
                        <table>
                            ...
                            @foreach($orderItems as $item)
                                <tr>
                                    <td width="10%">
                                        <label for=""> <img class="img-thumbnail ml-20" style="width: 70px; height: 70px;"
